...
@FacesConverter(value = "edificioConverter")
public class EdificioConverter implements Converter {

    @Inject
    private EdificioFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Edificio) {
            ...
            return getStringKey(o.getEdifCodigo());
        } else {
