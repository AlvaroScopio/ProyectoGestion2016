...
@FacesConverter(value = "paraleloConverter")
public class ParaleloConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Paralelo) {
            ...
            return getStringKey(o.getParaCodigo());
        } else {
